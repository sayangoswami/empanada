...
static void kt_for(int n_threads, void (*func)(void*,long,int), void *data, long n)
{
    if (n_threads > 1) {
        int i;
        kt_for_t t;
...
static void *kt_forpool_init(int n_threads)
{
    kt_forpool_t *fp;
    int i;
...
static void kt_forpool_destroy(void *_fp)
{
...
static void kt_forpool(void *_fp, void (*func)(void*,long,int), void *data, long n)
{
    kt_forpool_t *fp = (kt_forpool_t*)_fp;
    long i;
...
static void kt_pipeline(int n_threads, void *(*func)(void*, int, void*), void *shared_data, int n_steps)
{
    ktp_t aux;
    pthread_t *tid;
    int i;
